...
5. Download a zip for the AO/SCA: `status.md`, `host_package.md`, `requests.md`, `sar.md`, `controls.csv`, `poam.md`, `poam.csv`, `brief.md`, `pack.md`, `pack.json`, `pack.sha256`, `evidence.sha256`, `gap_report.md`, `schema/`, `/evidence/*`.
...
npm run ao-pack -- requests examples/model-bump-v1/pack.json
npm run ao-pack -- sar examples/model-bump-v1/pack.json

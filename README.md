...
5. Download a zip for the AO/SCA: `status.md`, `host_package.md`, `requests.md`, `poam.md`, `poam.csv`, `brief.md`, `pack.md`, `pack.json`, `pack.sha256`, `evidence.sha256`, `gap_report.md`, `schema/`, `/evidence/*`.
